...
import styles from "./styles/subCategoryTableComponent.module.css";



const SubCategoryTableComponent = ({
  columns,
  data = [],
  onEdit,
  isEmpty,
  ...
  return (
    <div>
      {isEmpty ? (
        <h3 className={styles.empty}>Please add some subcategories</h3>
      ) : (
...
export default SubCategoryTableComponent;
